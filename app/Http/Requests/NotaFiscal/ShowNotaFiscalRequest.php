...
use App\Http\Resources\NotaFiscal\FailedShowNotaFiscalRequestResource;
...
class ShowNotaFiscalRequest extends FormRequest
{
    /**
    ...
    {
        return Gate::allows('show-nota', $this);
    }
    ...
    {
        return [
            'numero' => 'sometimes|string|digits:9', // valida se é string e se possui 9 digitos
    ...
    protected function failedValidation(Validator $validator)
    {
        ...
        throw new HttpResponseException(response()->json(new FailedShowNotaFiscalRequestResource($validator->errors()), 422));
    }
}
