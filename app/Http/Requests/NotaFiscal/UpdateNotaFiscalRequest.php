...
use App\Http\Resources\NotaFiscal\FailedUpdateNotaFiscalRequestResource;
...
class UpdateNotaFiscalRequest extends FormRequest
{
    ...
    protected function failedValidation(Validator $validator)
    {
        ...
        throw new HttpResponseException(response()->json(new FailedUpdateNotaFiscalRequestResource($validator->errors()), 422));
    }
}
